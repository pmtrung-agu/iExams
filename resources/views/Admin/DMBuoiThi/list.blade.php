              ...
              @foreach($buoithi as $k => $kh)
                <tr>
                  ...
                  <td class="text-center">
                    ...
                    @endif --}}
                    <a href="{{ env('APP_URL') }}admin/buoi-thi/delete/{{ $kh['_id'] }}" onClick="return confirm('Chắc chắn xóa?');"><i class="fa fa-trash text-danger"></i></a>
                    <a href="{{ env('APP_URL') }}admin/buoi-thi/edit/{{ $kh['_id'] }}"><i class="fas fa-pencil-alt"></i></a>
                  </td>
                </tr>
              @endforeach
            @endif
