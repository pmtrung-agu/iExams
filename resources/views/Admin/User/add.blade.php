                            ...
                            <select class="select2 m-b-10 select2-multiple" name="roles[]" style="width: 100%" multiple="multiple" data-placeholder="Chọn quyền">
                                ...
                                @if($roles)
                                  @foreach($roles as $role => $role_name)
                                    <option value="{{ $role }}" @if(old('roles') !== null && in_array($role, old('roles'))) selected @endif >{{ $role_name }}</option>
                                  @endforeach
                                @endif
                            </select>
                        </div>
                          ...
                          <select name="id_dm_doiquanly[]" id="id_dm_doiquanly" multiple class="select2 form-control" data-placeholder="Chọn đội quản lý">
                            ...
                            @if($doiquanly)
                              @foreach($doiquanly as $dql)
                                <option value="{{ $dql['_id'] }}" @if(old('id_dm_doiquanly')!= null && in_array($dql['_id'], old('id_dm_doiquanly'))) selected @endif>{{ $dql['ten_doi'] }}</option>
                              @endforeach
                            @endif
                          </select>
                        </div>
