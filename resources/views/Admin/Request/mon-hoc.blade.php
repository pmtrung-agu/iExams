...
<div class="row">
    <div class="col-12 card-box">
        <h3 class="m-t-0"><a href="{{ env('APP_URL') }}admin/" class="btn btn-primary"><i class="mdi mdi-reply-all"></i></a> Danh mục Môn học</h3>
    </div>
</div>
<div class="row">
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#data-table').dataTable({
            "ajax" : '{{ env('APP_URL') }}admin/danh-muc/request-mon-hoc'
        });
    });
</script>
@endsection
