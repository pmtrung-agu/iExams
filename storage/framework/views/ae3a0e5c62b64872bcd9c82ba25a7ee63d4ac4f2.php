...
<script type="text/javascript">
    $(document).ready(function(){
        $('#data-table').dataTable({
            "ajax" : '<?php echo e(env('APP_URL')); ?>admin/danh-muc/request-nam-hoc'
        });
    });
</script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('Admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\iExams\resources\views/Admin/Request/nam-hoc.blade.php ENDPATH**/ ?>