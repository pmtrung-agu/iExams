              ...
              <?php $__currentLoopData = $buoithi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $kh): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                  ...
                  <td class="text-center">
                    ...
                    <a href="<?php echo e(env('APP_URL')); ?>admin/buoi-thi/delete/<?php echo e($kh['_id']); ?>" onClick="return confirm('Chắc chắn xóa?');"><i class="fa fa-trash text-danger"></i></a>
                    <a href="<?php echo e(env('APP_URL')); ?>admin/buoi-thi/edit/<?php echo e($kh['_id']); ?>"><i class="fas fa-pencil-alt"></i></a>
                  </td>
                </tr>
